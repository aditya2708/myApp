...
namespace App\Http\Controllers\AdminShalter\PemberdayaanShelter\DataBinaan\DataKeluarga;
...
class DataKeluargaShelterController extends Controller
{
    public function index(Request $request) {
        ...
        $query = Keluarga::with('kacab', 'wilbin', 'shelter') // Eager load relasi yang diperlukan
        ...
        // Jika ada filter tambahan, misalnya berdasarkan wilbin_id dari request
        ...
        return view('AdminShalter.Pemberdayaan.DataBinaan.DataKeluarga.index', compact('data_keluarga', 'kacab', 'wilbins'));
    }
    ...
    public function show($id_keluarga) {
        ...
        return view('AdminShalter.Pemberdayaan.DataBinaan.DataKeluarga.show', compact('keluarga', 'tab'));
    }
    ...
    public function destroy(Request $request, $id_keluarga) {
        ...
        return redirect()->route('keluarga.shelter')
    ...
    public function edit($id_keluarga) {
        ...
        $adminShelter = AdminShelter::where('user_id', $user_id)->first(); // Mengetahui cabang yang dimiliki oleh admin
        ...
        $keluarga = Keluarga::with(['kacab', 'wilbin', 'shelter', 'bank'])
                            ->where('id_kacab', $adminShelter->id_kacab) // Filter berdasarkan cabang admin
                            ->findOrFail($id_keluarga);
    
        // Mendapatkan data untuk form
        $kacab = Kacab::where('id_kacab', $adminShelter->id_kacab)->get(); // Hanya mengambil cabang terkait
        $wilbin = Wilbin::where('id_kacab', $adminShelter->id_kacab)->get(); // Hanya wilayah binaan sesuai cabang
        $shelter = Shelter::whereHas('wilbin', function($query) use ($adminShelter) {
        ...
        return view('AdminShalter.Pemberdayaan.DataBinaan.DataKeluarga.DataEditKeluarga.editdatakeluarga', 
    ...
    public function update(Request $request, $id_keluarga) {
        ...
        $adminShelter = AdminShelter::where('user_id', $user_id)->first(); // Mengetahui cabang admin yang sedang login
        ...
        $keluarga = Keluarga::where('id_kacab', $adminShelter->id_kacab)
                            ->findOrFail($id_keluarga);
        
        // Update data keluarga
        $keluarga->update($validatedData);
        
        return redirect()->route('Keluarga.show.shelter', $keluarga->id_keluarga)
    ...
    public function editAyah($id_keluarga) {
        ...
        return view('AdminShalter.Pemberdayaan.DataBinaan.DataKeluarga.DataEditAyah.editdatakeluargaayah', compact('ayah', 'provinsi'));
    }
    ...
    public function updateAyah(Request $request, $id_keluarga) {
        ...
        return redirect()->route('Keluarga.show.shelter', ['id' => $id_keluarga, 'tab' => 'data-ayah'])
    ...
    public function editIbu($id_keluarga) {
        ...
        return view('AdminShalter.Pemberdayaan.DataBinaan.DataKeluarga.DataEditIbu.editdatakeluargaibu', compact('ibu', 'provinsi'));
    }
    ...
    public function updateIbu(Request $request, $id_keluarga) {
        ...
        return redirect()->route('Keluarga.show.shelter', ['id' => $id_keluarga, 'tab' => 'data-ibu'])
    ...
    public function editWali($id_keluarga) {
        ...
        return view('AdminShalter.Pemberdayaan.DataBinaan.DataKeluarga.DataEditWali.editdatakeluargawali', compact('wali', 'provinsi'));
    }
    ...
    public function updateWali(Request $request, $id_keluarga) {
        ...
        return redirect()->route('Keluarga.show.shelter', ['id' => $id_keluarga, 'tab' => 'data-wali'])
