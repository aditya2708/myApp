...
use App\Services\AdminCabang\Reports\Attendance\MonthlyBranchAttendanceService;
use App\Support\SsoContext;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class AttendanceMonthlyBranchController extends Controller
{
    public function __invoke(Request $request, MonthlyBranchAttendanceService $service): JsonResponse
    {
        $user = $request->user();
        ...
        return response()->json([
            'success' => true,
            'message' => 'Laporan kehadiran bulanan cabang berhasil diambil.',
            'data' => $payload,
        ]);
    }
